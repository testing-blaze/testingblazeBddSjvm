...
public class UserPerforms {
    ...
    public UserPerforms (FrameManager frameManager, JavaScript javaScript, Ng ng, ElementAPI elementAPI, FindMyElements findMyElements, Properties_Logs pl, RobotActions ra, ScreenCapture sc, Sanitize sanitize, Waits wait, RestfulWebServices rWebServices,
                         ...
                         ElementReference elementRef, SoftAssertions softAssertions, Mobile mobile, Browser browser, Dates dates,AzureServiceBus azureServiceBus,DataBases dataBases) {
        this.pl=pl;
        this.ra=ra;
        this.sc=sc;
