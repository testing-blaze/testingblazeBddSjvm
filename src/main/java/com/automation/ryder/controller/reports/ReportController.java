...
import static com.automation.ryder.library.misc.ConsoleFormatter.ICON.NO_ICON;
...
public final class ReportController {
    ...
    private void printHtmlLog(LogLevel logLevel, ConsoleFormatter.COLOR color, ConsoleFormatter.ICON icon, String reportLog) {
        ...
        toReport += reportLog + "</pre>";
            scenarioController.getScenario().log((convertConsoleColorToHtmlTags(toReport)));
    }
